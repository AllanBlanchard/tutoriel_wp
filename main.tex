...
\image{resources/1-1-model.png}[Modélisation très abstraite d'un chronomètre]
...
\image{resources/1-2-verif_install-1.png}[Vérification installation 1]
...
\image{resources/1-2-verif_install-2.png}[Vérification installation 2]
...
\image{resources/1-2-select-coq.png}[Sélectionner l'assistant de preuve Coq]
...
\image{resources/2-1-1-abs-1.png}[Le volet latéral liste l’arbre des fichiers et des fonctions]
...
\image{resources/2-1-1-abs-2.png}[Lancer la vérification de ```abs``` avec WP]
...
\image{resources/2-1-1-abs-3.png}[Activer la vérification des erreurs d'exécution]
...
\image{resources/2-1-1-abs-4.png}[Preuve incomplète de ```abs```]
...
\image{resources/2-1-1-abs-5.png}[Tableau des obligations de preuve de WP pour ```abs```]
...
\image{resources/2-1-1-abs-6.png}[Obligation de preuve associée à la vérification de débordement dans ```abs```]
...
\image{resources/2-1-2-abs-1.png}[Preuve de ```abs``` effectuée]
...
\image{resources/2-1-2-foo-1.png}[Vérification du contrat à l'appel de ```abs```]
...
\image{resources/2-1-2-foo-2.png}[Obligation générée pour l'appel fautif]


\image{resources/2-1-2-foo-3.png}[Obligation générée pour l'appel qui suit]
...
\image{resources/2-2-2-swap-1.png}[Échec de preuve sur une globale non concernée par l'appel à ```swap```]
...
\image{resources/2-2-2-incr_a_by_b-1.png}[Échec de preuve : risque d'aliasing]
...
\image{resources/2-2-2-incr_a_by_b-2.png}[Résolution des problèmes d'aliasing]
...
\image{resources/2-4-max_abs.png}[Le contrat de ```max``` est valide par hypothèse]
...
\image{resources/3-3-1-i_30-1.png}[Obligations générées pour prouver notre boucle]
...
\image{resources/3-3-1-i_30-2.png}[Preuve de l'assertion par connaissance de l'invariant et l'invalidation de la condition de boucle]
...
\image{resources/3-3-boucle-effet-bord.png}[Encore des effets de bord]
...
\image{resources/3-3-infinite.png}[Preuve de faux par non-terminaison de boucle]
...
manière :
\inlineImage{resources/3-3-goto_end.png}
...
\image{resources/3-3-boucle_complete.png}[Notre simple boucle complètement spécifiée et prouvée]
...
\image{resources/3-4-trivial-establishment.png}[But trivial]
...
\image{resources/4-3-affine-1.png}[Les débordements semblent pouvoir survenir]
...
\image{resources/5-1-1-premier-axiome.png}[Premier axiome, supposé vrai par Frama-C]
...
\image{resources/false_axiom.png}[Preuve de tout un tas de choses fausses]
