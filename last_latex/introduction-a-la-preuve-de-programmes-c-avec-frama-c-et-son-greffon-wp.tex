...
\date{\color{white}{$ $\\24 février 2017}}
\end{titlepage}
...
la suivante (\(\top\) = \texttt{true}, \(\bot\) = \texttt{false}) :
...
\midrule
\endhead
\(\bot\) & \(\bot\) & \(\top\)\tabularnewline
\(\bot\) & \(\top\) & \(\top\)\tabularnewline
\(\top\) & \(\bot\) & \(\bot\)\tabularnewline
\(\top\) & \(\top\) & \(\top\)\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
\(\bot\) & \(\bot\) & \(\top\) & \(\bot\) & \(\bot\) & \(\top\) &\(\top\)\tabularnewline
\(\bot\) & \(\top\) & \(\top\) & \(\bot\) & \(\top\) & \(\top\) &\(\bot\)\tabularnewline
\(\top\) & \(\bot\) & \(\bot\) & \(\bot\) & \(\top\) & \(\bot\) &\(\bot\)\tabularnewline
\(\top\) & \(\top\) & \(\bot\) & \(\top\) & \(\top\) & \(\top\) &\(\top\)\tabularnewline
\bottomrule
\end{longtable}
\end{zdsblock}
