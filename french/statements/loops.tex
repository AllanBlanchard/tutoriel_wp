...
propriété, mais une valeur. C'est une expression faisant intervenir des éléments
...
assurer que la valeur est positive et qu'elle décroît strictement pendant
l'exécution de la boucle. Si nous supprimons la ligne de code qui incrémente
\CodeInline{i}, WP ne peut plus prouver que la valeur \CodeInline{30 - i}
décroît strictement.
