...
En utilisant l'option \CodeInline{-wp-no-subst} au lancement, nous pouvons quand
...
\CodeInline{-wp-no-qed} pour éviter une preuve immédiate par Qed) :
...
(à nouveau, nous utilisons l'option \CodeInline{-wp-no-qed} et nous avons
