...
Cette pré-condition nous atteste que les adresses \CodeInline{a+0}, 
...
contrat, la propriété que vous aurez choisi pour la fonction \CodeInline{pred}
...
comme un \CodeInline{size\_t}. Vous devrez modifier légèrement l'algorithme et 
la spécification/les invariants. Conseil : arrangez vous pour que \CodeInline{up}
...
Écrire, spécifier et prouver la fonciton qui ajoute deux vecteurs dans un
...
Utilisez la fonction \CodeInline{swap} précédemment prouvée.
