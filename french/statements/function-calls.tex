...
(puisqu'elle pourrait appeler \CodeInline{exit}) et cet appel, nous utilisons la
clause \CodeInline{exits} comme postcondition, ensuite, lorsque nous continuons
le raisonnement arrière, nous utilisons les clauses \CodeInline{ensures} comme
...
\begin{Information}
  ...
  \item \CodeInline{-wp-frama-c-stdlib-terminate} (pour les fonctions de la stdlib de Frama\nobreakdash-C),
  \end{itemize}
