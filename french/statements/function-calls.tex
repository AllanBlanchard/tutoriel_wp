...
dans la postcondition est \CodeInline{*a} ay label \CodeInline{L2}. Par conséquent,
...
modifiées, nous voulons celles \emph{qui permettent de satisifaire la postcondition}.
...
Nous pouvons appliquer le calul de plus faible précondition :
