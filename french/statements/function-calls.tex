...
en désactivant la simplification du but (option \CodeInline{-wp-no-qed}, ici,
...
\begin{Information}
  ...
  le lecteur peut se référer à la documentation de la clause \CodeInline{calls}
  dans le manuel utilisateur de Frama-C.
\end{Information}
...
\CodeInline{-wp-no-qed} pour désactiver les simplifications du but) :
