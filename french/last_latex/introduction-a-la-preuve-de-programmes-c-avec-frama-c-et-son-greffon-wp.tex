...
\emph{\href{http://www.fokus.fraunhofer.de/download/acsl_by_example.pdf}{ACSL
...
\begin{zdsblock}{Information}
  ...
  \begin{footnotesize}\begin{Shaded}
      \begin{Highlighting}[]
        \KeywordTok{$} \KeywordTok{frama-c-gui} \KeywordTok{-gui-theme} \KeywordTok{colorblind} \KeywordTok{fichier.c}
      \end{Highlighting}
  \end{Shaded}\end{footnotesize}
\end{zdsblock}
