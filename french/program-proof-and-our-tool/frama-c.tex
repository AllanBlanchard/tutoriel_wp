...
Notons qu'il est possible de suivre les étapes d'installation que
nous venons d'introduire pour Linux dans le cas d'une installation
dans Windows Subsystem for Linux.
...
\begin{Information}
  Nous n'avons pas expérimenté cette procédure sous Windows avec Cygwin.
  Avec WSL, cela devrait fonctionner.
\end{Information}
