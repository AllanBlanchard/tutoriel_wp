...
d'argent reçue et un buffer pour indiquer combien de chaque billet/pièce
doit être retournée au client.
...
collectées dans un structure \CodeInline{info} reçue via un pointeur.
