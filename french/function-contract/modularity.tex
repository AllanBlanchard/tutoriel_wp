...
en isolation les unes des autres. Nous voyons aussi des pastilles jaunes pour
les clauses \CodeInline{exits} et \CodeInline{terminates}. Comme Frama-C génère
ces clauses et n'a aucun moyen de vérifier leur correction, il indique à
l'utilisateur qu'il devrait vérifier leur correction (ou les écrire
explicitement, auquel cas Frama-C pourra supposer qu'elles sont correctes,
exactement de la même manière que pour les clauses \CodeInline{ensures} et
\CodeInline{assigns} que nous avons écrites).
...
\CodeBlockInput[6][16]{c}{max_abs.h}
