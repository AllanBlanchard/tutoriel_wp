...
est l'option « détecteur de fumée » du greffon. Elle peut être utilisée pour
détecter que des préconditions ne peuvent pas être satisfaites. Par exemple, ici,
nous pouvons lancer cette ligne de commande :
...
Notons que lorsque les tests du détecteur de fumée réussisse, par exemple si
