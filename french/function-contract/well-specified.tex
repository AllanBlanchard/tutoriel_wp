...
tramsettons à la fonction \CodeInline{\textbackslash{}at} est propagé également
...
Trouver les bonnes pré-conditions à une fonction est parfois difficile. Il est
...
la fonction valeur absolue n'a, au fond, pas  vraiment de pré-condition à respecter,
...
pointée par le première paramètre si celle pointée par le second est
vraie. Ne pas oublier d'exprimer que la valeur pointée par le second
