...
propriété a été prouvée et les différents prouveurs qui ont été utilisés. Le
premier prouveur est souvent Qed. Ce n'est pas réellement un prouveur, mais un
outil utilisé par WP pour simplifier les propriétés avant de les envoyer
réellement aux prouveurs externes, il se peut que cet outil soit en mesure de
résoudre le problème par lui-même, dans ce cas, aucun autre prouveur n'est
appelé. Sinon, les prouveurs utilisés sont listés. Par exemple ici, Alt-Ergo
qui est l'un des prouveurs que nous utilisons. Notons que pour la propriété liée
à RTE, un « timeout » est indiqué, ce qui signifie que le prouveur s'est arrêté,
car la preuve lui a pris trop de temps.
