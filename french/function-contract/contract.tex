...
%% TODO: when implemented, talk about side menu

Nous pouvons activer ce contrôle pour toute fonction que l'on vérifie via le
menu « Edit », « Frama-C Parameters », « WP »
...
Il est également possible de demander à WP d'ajouter ces contrôles par un clic
droit sur le nom de la fonction puis « Insert wp-rte guards ».
