...
\begin{itemize}
\item Frama-C 33.0 Arsenic
\item Why3 1.8.2
\item Alt-Ergo 2.6.1
\item Coq 8.20.1 (pour les scripts proposés, Coq n'est pas utilisé dans le tutoriel)
\item CVC5 1.3.3 (pour quelques exemples)
\item Z3 4.8.12 (pour quelques exemples)
\end{itemize}
