...
\begin{itemize}
\item Frama-C 21 Scandium
\item Why3 1.3.1
\item Alt-Ergo 2.0.0
\item Coq 8.11.1 (pour les scripts proposés, Coq n'est pas utilisé dans le tutoriel)
...
anglaise du tutoriel, ainsi qu’à Rafael Bachmann et Basile Deslosges pour
leurs relectures et corrections.
\end{Information}
