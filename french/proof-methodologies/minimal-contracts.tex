Nous avons vu que la preuve d'un programme nous permet de vérifier deux aspects
...
Prouver l'absence d'erreurs à l'exécuton dans la fonction \CodeInline{reverse}
...
contrats minimaux. Ne pas oublier d'ajouter l'option \CodeInline{-warn-unsigned-overflow}.
...
l'option \CodeInline{-warn-unsigned-overflow}.
...
oublier d'ajouter l'option \CodeInline{-warn-unsigned-overflow}.
