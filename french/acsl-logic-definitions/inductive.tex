...
Exprimer d'abord le lemme \CodeInline{power\_even}, les solveurs SMT seront capables
de combiner ce lemme avec la définition inductive pour déduire \CodeInline{power\_odd}.
La preuve Coq de \CodeInline{power\_even} est fournie sur le répertoire GitHub de ce
livre.
