...
définition inductive en nous assurant que chaque cas est de la forme :
...
Les prédicats inductifs sont souvent utiles pour exprimer des propriétés récursivement
...
Dans cet exercice, nous ne considérerons pas les RTEs.
