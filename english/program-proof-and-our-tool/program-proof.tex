...
\item the program is not correct according to the specification that we
      ...
      find the index of minimal value of an array, but in fact, due to an
      error, it does not check the last value of the array),
\item the specification does not exactly reflect what we had in mind for
      ...
      index of the minimal value of the array, but we did not specified that
