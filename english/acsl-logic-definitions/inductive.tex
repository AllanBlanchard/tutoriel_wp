...
\CodeInline{even\_natural} we just proposed, Coq complains when we try to prove
the \CodeInline{ensures \textbackslash{}false}, because there exists a non
...
\item if some \CodeInline{d} is the GCD of \CodeInline{b} and \CodeInline{a \% b} and
  thus, then it is the GCD of \CodeInline{a} and \CodeInline{b}
\end{itemize}
