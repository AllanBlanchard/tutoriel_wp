...
Finally, we can remark that there exists two way to change the control
...
the pointed memory is not considered as ghost (and thus here, while
...
Add a ghost parameter to \CodeInline{replace} so that it can receive an
