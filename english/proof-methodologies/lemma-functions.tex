...
\CodeBlockInput[273][292]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[144][160]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[131][141]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[251][253]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[189][206]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[162][187]{c}{insert-sort-auto-proved.c}
...
\begin{itemize}
\item 177--181: we recall that in the original array we can split the last
  element,
\item 182--186: we show that as the first element of the array is
  the last element of the original array (182), the number of occurrences for
  any value in these ranges is the same (183--185).
\end{itemize}
...
\CodeBlockInput[247][249]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[217][222]{c}{insert-sort-auto-proved.c}


Note that depending on the version of the solvers, the assertion on lines 182 to
186 of the macro, about the element at the beginning/the end of the array might
...
\CodeBlockInput[208][256]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[1][14]{c}{ex-1-sum-of-n-integers.c}
