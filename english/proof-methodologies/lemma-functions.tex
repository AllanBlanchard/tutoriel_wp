...
integers while in the lemma function its type is \CodeInline{size\_t}. It means
...
\CodeBlockInput[25][41]{c}{insert-sort-auto.c}
...
\CodeBlockInput[42][47]{c}{insert-sort-auto.c}
...
\CodeBlockInput[86][107]{c}{insert-sort-auto.c}
...
assuming that this second part is unchanged (when \CodeInline{i+1} is less than
\CodeInline{end} as else, we do not have anything to count):


\CodeBlockInput[266][285]{c}{insert-sort-auto-proved.c}


which enough to ensure that the \CodeInline{insertion\_sort} function respects
its specification as long as we finish the proof of \CodeInline{insert}. This
second version does a more complex action. Let us depart from this annotated
version:


\CodeBlockInput[49][83]{c}{insert-sort-auto.c}
...
\CodeBlockInput[56][74]{c}{insert-sort-auto-proved.c}


We can note that this property is proved in a way that is quite similar to
what we wrote for the body of our loop in \CodeInline{insertion\_sort}, we
...
that we can split the array at any index, thus make the \CodeInline{split}
variable a universally quantified variable, and use the previous function
to prove that it is true:


\CodeBlockInput[76][97]{c}{insert-sort-auto-proved.c}
...
in the \CodeInline{insertion\_sort} function. We start by building the context
for our proof:


\CodeBlockInput[137][153]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[124][134]{c}{insert-sort-auto-proved.c}


Which almost corresponds to what we have written previously in the
\CodeInline{insert\_sort} function. Now we can use the macro where it is needed
in the \CodeInline{insert} function.


\CodeBlockInput[244][246]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[182][199]{c}{insert-sort-auto-proved.c}
...
will insert our use of the macro int othe \CodeInline{insert} function.


Let us now present the macro that we use to prove that the lemma holds:


\CodeBlockInput[155][180]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[48][53]{c}{insert-sort-auto-proved.c}
...
\CodeBlockInput[201][249]{c}{insert-sort-auto-proved.c}
