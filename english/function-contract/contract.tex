...
We can configure this option globally for all functions we verify in the
``Edit'' menu, ``Frama-C Parameters'', ``WP''
...
We can also ask WP to add the RTE controls in a function by right-clicking on
its name and then click ``Insert wp-rte guards''.
