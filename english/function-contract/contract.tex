...
\image{1-abs-1}[The side panel gives the files and functions tree]
...
\image{1-abs-2}[Start the verification of \texttt{abs} with WP]
...
\image{1-abs-3}[Activate runtime error absence verification]
...
\image{1-abs-4}[Incomplete proof of \texttt{abs}]
...
\image{1-abs-5}[Proof obligations panel of WP for \CodeInline{abs}]
...
\image{1-abs-6}[Proof obligation associated to the verification of absence of
...
\image{2-abs-1}[Proof of \texttt{abs} performed]
...
\image{2-foo-1}[Precondition checking when calling \CodeInline{abs}]
...
\image{2-foo-1-bis}[Unfolded precondition checking when calling \CodeInline{abs}]
...
\image{2-foo-2}[Generated proof obligation for the bad call]


\image{2-foo-3}[Generated proof obligation for the call that follows]
