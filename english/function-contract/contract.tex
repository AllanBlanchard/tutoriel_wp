...
\image{1-abs-1.png}[The side panel gives the files and functions tree]
...
\image{1-abs-2.png}[Start the verification of \texttt{abs} with WP]
...
\image{1-abs-3.png}[Activate runtime error absence verification]
...
\image{1-abs-4.png}[Incomplete proof of \texttt{abs}]
...
\image{1-abs-5.png}[Proof obligations panel of WP for \CodeInline{abs}]
...
\image{1-abs-6.png}[Proof obligation associated to the verification of absence of
...
\image{2-abs-1.png}[Proof of \texttt{abs} performed]
...
\image{2-foo-1.png}[Precondition checking when calling \CodeInline{abs}]
...
\image{2-foo-1-bis.png}[Unfolded precondition checking when calling \CodeInline{abs}]
...
\image{2-foo-2.png}[Generated proof obligation for the bad call]


\image{2-foo-3.png}[Generated proof obligation for the call that follows]
