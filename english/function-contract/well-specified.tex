...
Try to minimize the amount of separation needed. In order to find the
minimal separation, take care of the postcondition of the function that
expresses the order of the values, and consider the case when exactly two
different values are provided to the function.
