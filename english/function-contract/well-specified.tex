...
This while being a correct specification of \CodeInline{max}, our specification
...
verification), our postcondition is indeed verified but WP fails to
prove that some runtime-error cannot happen, since we perform access to
...
example, our \CodeInline{swap} function can be specified like this:
