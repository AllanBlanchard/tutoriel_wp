...
The goal of this exercise is to write a function that compute the change
...
Write the code of these functions and its specification and prove its
...
\CodeInline{a} is the hypotenus. If these values do not correspond to a
...
to write a version that do not requires \CodeInline{a} to be the hypotenus.
Note however that it could be hard to finish the proof automatically with
