...
leads to our postcondition. However, first, this version is simpler to understand,
...
the role of the \CodeInline{decreases} clause in ACSL:
...
The expression considered by a decrease clause is a positive integer that
