...
The \CodeInline{decreases} expression associated to the function under proof is
considered at \CodeInline{Pre} state: the value of the expression when a
recursive call is done must be smaller that the value of the expression at
\CodeInline{Pre} state.
