...
\CodeInline{in\_array\_shifted} that should state that if a value is a range of
values and that is then shifted, it is still in the resulting new range. The
